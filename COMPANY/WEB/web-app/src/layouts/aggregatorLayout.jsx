...
export default function Agg() {
  ...
  const menu = [
    ...
    { id: "community", label: "Community", icon: <Users size={25} /> },
    ...
    switch (activeTab) {
      ...
      case "community":
        return (
          ...
          //   <div className="p-6">
          //     <h1 className="text-xl font-semibold mb-4">Your Community</h1>
          //     <p className="text-gray-600 text-sm">Request and monitor waste Community.</p>
          //   </div>
        );
      case "wallet":
        return (
