...
//     const { userData, wallet, isLoading } = useSelector((state) => state.auth);

//   if (isLoading && !userData) {
//     console.log("data is loading", isLoading,wallet)
//     return <div className="bg-black-500 spinner">Fetching your wallet...</div>;
//   }
