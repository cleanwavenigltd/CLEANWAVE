  ...
  return (
    <div className="relative w-full mb-4">
      <input
        ...
        placeholder=" " 
        required={required}
        className="pl-10 py-3 pr-4 bg-transparent peer h-15 w-full text-gray-900 placeholder-transparent border border-gray-300 rounded-md pt-5 pb-2 focus:outline-none focus:ring-2 focus:ring-[#8CA566] focus:border-[#8CA566] transition-all"
      />
      <label
        htmlFor={name}
        className="absolute left-9 -top-2 bg-white px-1 text-gray-500 text-[10px] cursor-pointer transition-all 
